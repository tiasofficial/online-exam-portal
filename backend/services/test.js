...
var addExamQuestion = async (req, res, next) => {
  ...
  try {
    ...
    if (req.files) {
      if (req.files['bodyImage']) bodyImage = '/uploads/' + req.files['bodyImage'][0].filename;
      if (req.files['optImg1']) optionImages[0] = '/uploads/' + req.files['optImg1'][0].filename;
      if (req.files['optImg2']) optionImages[1] = '/uploads/' + req.files['optImg2'][0].filename;
      if (req.files['optImg3']) optionImages[2] = '/uploads/' + req.files['optImg3'][0].filename;
      if (req.files['optImg4']) optionImages[3] = '/uploads/' + req.files['optImg4'][0].filename;
    }
...
var editExamQuestion = async (req, res, next) => {
  ...
  try {
    ...
    // Process uploaded images
    if (req.files) {
      if (req.files['bodyImage']) question.bodyImage = '/uploads/' + req.files['bodyImage'][0].filename;
      if (req.files['optImg1']) question.optionImages[0] = '/uploads/' + req.files['optImg1'][0].filename;
      if (req.files['optImg2']) question.optionImages[1] = '/uploads/' + req.files['optImg2'][0].filename;
      if (req.files['optImg3']) question.optionImages[2] = '/uploads/' + req.files['optImg3'][0].filename;
      if (req.files['optImg4']) question.optionImages[3] = '/uploads/' + req.files['optImg4'][0].filename;
    }
